...
Branch::Branch(const int ID, const std::string &Name, const std::string &Location, const std::shared_ptr<Menu> &menu) : m_BranchID(ID),
...
void Restaurant::AddBranch(std::shared_ptr<Branch> branch)
{
    if (branch == nullptr)
    {
